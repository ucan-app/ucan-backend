...
public class UserPostController {
  ...
  public ResponseEntity<UserPostDTO> createPost(
      @RequestParam String title, @RequestParam String description, @RequestParam UUID creatorId) {
  ...
  public ResponseEntity<UserPostDTO> updatePost(
      @PathVariable UUID postId, @RequestParam String title, @RequestParam String description) {
