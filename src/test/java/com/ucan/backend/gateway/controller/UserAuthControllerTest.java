...
public class UserAuthControllerTest {
    ...
    @Mock
    private UserAuthAPI mockUserAuthService;
    ...
    void setUp() {
        ...
        expectedUserDTO = new UserAuthDTO(1L, "testuser", "test@example.com", "encodedPassword", true); // Assuming ID is generated and password encoded
    }

    @Test
    void register_whenServiceThrowsIllegalArgumentException_shouldReturnBadRequestWithErrorResponse() {
        ...
        assertEquals(errorMessage, errorResponse.message(), "Error message should match the exception message");
